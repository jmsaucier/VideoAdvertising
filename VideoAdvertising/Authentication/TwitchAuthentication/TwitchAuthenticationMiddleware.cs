...
namespace VideoAdvertising.Authentication.TwitchAuthentication
{
    ...
    public class TwitchAuthenticationMiddleware : AuthenticationMiddleware<TwitchAuthenticationOptions>
    {
        ...
        /// <summary>
        /// Initializes a <see cref="TwitchAuthenticationMiddleware"/>
        /// </summary>
        ...
        /// </summary>
        /// <returns>An <see cref="AuthenticationHandler"/> configured with the <see cref="TwitchAuthenticationOptions"/> supplied to the constructor.</returns>
